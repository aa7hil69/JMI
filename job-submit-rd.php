...
<body class="body-dark">
    <div class="page-wrapper">
        ...
        <section class="page-banner">
            <div class="image-layer" style="background-image: url(images/slide/01.jpg);"></div>
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                        <div class="job-details-content">
                            <div class="upper-box">
                                <div class="inner-box">
                                    <div class="inner">
                                        <h3>Don’t see a job that fits your skills? Drop your Resume here.</h3>
                                    </div>
                                </div>
                            </div>
                            <div class="text" style="border:0;margin-bottom:0;padding-bottom:0;">
                                <h2>Apply Now</h2>
                                <p>Please fill out the form to submit your Resume.</p>
                            </div>
                            <div class="default-form">
                                <form method="post" action="" id="contact-form" enctype="multipart/form-data">
                                    <div class="row clearfix">
                                        ...
                                        <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                            <div class="field-inner">
                                                <input type="text" name="phone" value="" placeholder="Phone Number (numbers only)" required="" oninput="this.value = this.value.replace(/[^0-9]/g, '')" maxlength="15">
                                            </div>
                                        </div>
                                        <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                            <div class="field-inner">
                                        ...
                                        <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                            <div class="field-inner">
                                                <label for="resume">Upload Resume (PDF or Word format only)</label><br>
                            ...
                            <div class="sidebar-widget archives">
                                <div class="widget-inner">
                                    <div class="sidebar-title">
                                        ...
                                        <ul><li><a href="job-details.php?job_id=21">Omani Graduate Trainees</a></li><li><a href="job-details.php?job_id=22">Project Manager for GP Project</a></li><li><a href="job-details.php?job_id=23">Multiple - Omani Nationals only</a></li><li><a href="job-details.php?job_id=26">AI Expert &amp; Consultant</a></li><li><a href="job-details.php?job_id=27">Investment Director</a></li><li><a href="job-details.php?job_id=29">AI Quality Engineer</a></li><li><a href="job-details.php?job_id=31">Testing &amp; Commissioning Engineer</a></li><li><a href="job-details.php?job_id=32">Power &amp; Substation Professionals</a></li><li><a href="job-details.php?job_id=35">Head of Events &amp; Communications</a></li><li><a href="job-details.php?job_id=36">Various</a></li><li><a href="job-details.php?job_id=40">Various Technical</a></li><li><a href="job-details.php?job_id=41">Event &amp; Sponsorship Manager</a></li><li><a href="job-details.php?job_id=42">FMCG Roles - Multiple Positions</a></li><li><a href="job-details.php?job_id=43">Assistant Finance Manager</a></li><li><a href="job-details.php?job_id=44">HR &amp; Learning and Development Executive</a></li><li><a href="job-details.php?job_id=45">Sales &amp; Marketing Executives - Steel Industry</a></li></ul>                                        <!-- <ul>
                                        <li><a href="job-details.php">Finance Manager & Health</a></li>
                                        <li><a href="job-details.php">Assistant Bank Manager - Savage</a></li>
                                        <li><a href="job-details.php">Vice President of Finance</a></li>
                                        <li><a href="job-details.php">Emergency Medicine Physician</a></li>
                                        <li><a href="job-details.php">Senior Technical Writer</a></li>
                                        <li><a href="job-details.php">Restaurant Assistant Manager</a></li>
                                        <li><a href="job-details.php">Finance Manager & Health</a></li>
                                        <li><a href="job-details.php">Assistant Bank Manager - Savage</a></li>
                                        <li><a href="job-details.php">Vice President of Finance</a></li>
                                        <li><a href="job-details.php">Emergency Medicine Physician</a></li>
                            ...
                            <div class="footer-widget info-widget">
                                <div class="widget-content">
                                    ...
                                    <ul class="contact-info">
                                        <li class="address">
                                            <span class="icon flaticon-pin-1"></span> 126 Broklyn Street,
                                            New York <br>United States of America
                                        </li>
                                        <li>
                                            <span class="icon flaticon-call"></span><a href="tel:00944 2652 321">00944 2652 321</a>
                                        </li>
                                        <li>
                                            <span class="icon flaticon-email-2"></span><a href="mailto:contact@jminternational.com">contact@jminternational.com</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
    ...
    <script>
// Client-side validation for Name, Email & Phone (Numbers only)
document.getElementById('contact-form').addEventListener('submit', function(e) {
    ...
    if (phone === '') {
        ...
        errors.push('⚠ Phone number must contain numbers only (no spaces or symbols).');
    } else if (phone.length < 5 || phone.length > 15) {
        errors.push('⚠ Phone number should be 5–15 digits long.');
    }

    // 4. Resume (optional - just in case someone removes "required")
    if (!document.querySelector('input[name="resume"]').files.length) {
        errors.push('⚠ Please upload your resume.');
    }

    // If any error → stop form submission and show alert
    if (errors.length > 0) {
        e.preventDefault();
        alert(errors.join("\n"));
        return false;
